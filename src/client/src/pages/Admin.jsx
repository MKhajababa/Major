            ...
            <div className="flex h-full items-center justify-center">
                ...
                <div className="">
                    ...
                    <div className="btn-group m-3 ">
                        <input type="radio" name="options" data-title="Open" className="btn w-[150px]" onClick={selectOpenTender} />
                        <input type="radio" name="options" data-title=" Tender" className="btn w-[150px]" onClick={selectOpenTender} />
                    ...
                    <div className="items-center m-3">
                        ...
                        <input type="datetime-local" placeholder='Start Time' className='input input-bordered input-primary w-full max-w-xs' onChange={handleChangeStartTime}/>
                    </div>

                    <div className="items-center m-3">
                        <h1 className="ml-4 mb-2 text-lg font-semibold">End Time</h1>
                        
                        <input type="datetime-local" placeholder='End Time' className='input input-bordered input-primary w-full max-w-xs' onChange={handleChangeEndTime}/>
                    </div>
                    

                    <div className="flex justify-center">
                        <button className="btn bg-primary" onClick={createTender}>Create tender</button>
                    </div>
