...
export const TransactionProvider =({ children })=> {
    ...
    const [tenderType, setTenderType] = useState(0);
    ...
    const handleChangeStartTime = (e) => {
        ...
        var t = Date.parse(e.target.value);
        setStartTime(String(t/1000));
        console.log(startTime);
    }

    const handleChangeEndTime = (e) => {
        var p = Date.parse(e.target.value);
        setEndTime(String(p/1000));
        console.log(endTime);
    }
